...
namespace App\Http\Controllers\Front\TechController;
...
class TechController extends Controller
{
    ...
    public function all(){
        ...
        ->where('posts.status','1')->where('category_id','16')->orderBy('posts.created_at','DESC')->get();
        ...
        return view('front.Tech.all',get_defined_vars());
    ...
    public function tech(){
        ...
        $tech = Posts::join('categories','categories.id','=','posts.category_id')
        ->select('posts.id','posts.description','posts.content','posts.image','posts.view','posts.status','posts.category_id as category_id','categories.title as cat_title','posts.title as post_title','posts.created_at','posts.reading_time')
        ->where('posts.status','1')->where('category_id','16')->orderBy('posts.created_at','DESC')->get()->toArray();
        ...
        ->where('posts.status','1')->where('category_id','16')->orderBy('posts.created_at','DESC')->skip(11)->take(10)->get();
        ...
        return view('front.Tech.tech',get_defined_vars());
    }
