...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Reklamlar | Footer</li>
            </ol>
        </div>
    </div>
    <!-- PAGE-HEADER END -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header border-bottom">
                    <h3 class="card-title">Reklamlar | Footer</h3>
                </div>
                <div class="card-body">
    ...
    <div class="modal fade"  id="addAdvert">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <form action="{{route('advertFooter')}}" method="POST" enctype="multipart/form-data" class="modal-content modal-content-demo">
                @csrf
                    ...
                    <div class="row row-xs form-group-wrapper">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="alert alert-info alert-dismissible fade show" role="alert">
                                Tövsiyyə olunan ölçü 1330x300px
...
@section('js')
    <script>
        ...
        const ChangeStatus = (id) => {
            ...
            $.ajax({
                type: "POST",
                url: "/admin/adverts/footer/status",
                data: {
                    _token: CSRF_TOKEN,
                    id,
                },
            ...
            swal({
                ...
                function(isConfirm) {
                    if (isConfirm) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "/admin/adverts/footer/delete",
                            data: {
                                _token: CSRF_TOKEN,
                                id,
                            },
