                ...
                <div class="col-md-3 mt-3 paper-blog2-bottom-left-col">
                    <div class="paper-blog2-bottom-left">
                        ...
                        <div class="paper-blog2-content">
                            ...
                            {!! htmlspecialchars_decode($travel[9]['post_title'])!!}</a>
                            <p>
                                {!! htmlspecialchars_decode($travel[9]['description'])!!}
                            </p>
                        </div>
                        <div class="paper-blog2-button">
                    ...
                    <div class="paper-1">
                        ...
                        <div class="blog-det-2">
                            <a href="{{ route('detail', ['id' => $travel[10]['id']]) }}" style="color: #020202; text-decoration:none">
                                {!! htmlspecialchars_decode($travel[10]['post_title'])!!}</a>
                            <p>{!! htmlspecialchars_decode($travel[10]['description'])!!}</p>
                        </div>
                        <div class="blog-det-3">
