        ...
        <div class="container paper-container mt-4">
            <div class="row">
                <div class="col-md-6">
                    <div class="paper-col6">
                        <div class="paper-blog2-img">
                            <img src="{{ $film[0]['image'] }}" alt="blog2" />
                        </div>
                        ...
                        <div class="paper-blog2-content">
                            <a href="{{ route('detail', ['id' => $film[0]['id']]) }}"
                        ...
                        <div class="paper-blog2-button">
                            <a
                                href="{{ route('detail', ['id' => $film[0]['id']]) }}"><button>
                                    Daha çox
                    ...
                    <div class="paper-blog2-bottom">
                        <div class="paper-blog2-bottom-left">
                            ...
                            <div class="paper-blog2-content">
                                <a href="{{ route('detail', ['id' => $film[1]['id']]) }}"
                                    style="color: #020202; text-decoration:none">
                            ...
                            <div class="paper-blog2-button">
                                <a
                                    href="{{ route('detail', ['id' => $film[1]['id']]) }}"><button
                        ...
                        <div class="paper-blog2-bottom-right">
                            ...
                            <div class="paper-blog2-content">
                                <a href="{{ route('detail', ['id' => $film[2]['id']]) }}"
                                    style="color: #020202; text-decoration:none">
                            ...
                            <div class="paper-blog2-button">
                                <a
                                    href="{{ route('detail', ['id' => $film[2]['id']]) }}"><button
                                        class="read-more">Daha çox
                ...
                <div class="col-md-3 col-5">
                    <div class="paper-1">
                        <img class="paper-1-img" src="{{ $film[3]['image'] }}"
                            alt="paper-1-img" />
                        <div class="blog-det">
                            <div class="blog-date">
                        ...
                        <div class="blog-det-2">
                            <a href="{{ route('detail', ['id' => $film[3]['id']]) }}"
                                style="color: #020202; text-decoration:none">
                        ...
                        <div class="blog-det-3">
                            <a
                                href="{{ route('detail', ['id' => $film[3]['id']]) }}"><button
                                    class="read-more">
                                    Daha çox
                                    <img src="{{ asset('back/assets/img/more.png') }}" alt="">
                                </button>
                ...
                <div class="col-md-3 col-7 paper-k-content-mobile">
                    <div class="paper-blog1-bottom-left">
                        ...
                        <div class="paper-blog2-content">
                            <a href="{{ route('detail', ['id' => $film[4]['id']]) }}"
                                style="color: #020202; text-decoration:none">
                        ...
                        <div class="paper-blog2-button">
                            <a
                                href="{{ route('detail', ['id' => $film[4]['id']]) }}"><button>
                                    Daha çox
                                    <img src="{{ asset('back/assets/img/more.png') }}" alt="more" />
                                </button>
                            </a>
                    ...
                    <div class="paper-2">
                        <img class="paper-1-img" src="{{ $film[5]['image'] }}"
                            alt="paper-1-img" />
                        <div class="blog-det">
                            <div class="blog-date">
                        ...
                        <div class="blog-det-2">
                            <a href="{{ route('detail', ['id' => $film[5]['id']]) }}"
                                style="color: #020202; text-decoration:none">
                        ...
                        <div class="blog-det-3">
                            <a
                                href="{{ route('detail', ['id' => $film[5]['id']]) }}"><button
                                    class="read-more">
                                    Daha çox
                                    <img src="{{ asset('back/assets/img/more.png') }}" alt="">
                                </button>
                ...
                <div class="col-12 mobile-paper-2">
                    <img class="paper-1-img" src="{{ $film[6]['image'] }}" alt="paper-1-img" />
                    <div class="blog-det">
                        <div class="blog-date">
                    ...
                    <div class="blog-det-2">
                        <a href="{{ route('detail', ['id' => $film[6]['id']]) }}"
                            style="color: #020202; text-decoration:none">
                    ...
                    <div class="blog-det-3">
                        <a
                            href="{{ route('detail', ['id' => $film[6]['id']]) }}"><button
                                class="read-more">
                                Daha çox
                                <img src="{{ asset('back/assets/img/more.png') }}" alt="">
                            </button>
                ...
                <div class="col-md-3 mt-4">
                    <div class="paper-elizabeth-wrapper">
                        <div class="d-flex align-items-center justify-content-center paper-elizabeth-img">
                            <img class="w-100" src="{{ $film[7]['image'] }}" alt="elizabeth" />
                        </div>
                        <div class="paper-blog3-bottom-left">
                            ...
                            <div class="paper-blog2-content">
                                <a href="{{ route('detail', ['id' => $film[7]['id']]) }}"
                                    style="color: #020202; text-decoration:none">
                ...
                <div class="col-md-6 mt-4">
                    <div class="paper-col6">
                        <div class="paper-blog2-img">
                            <img src="{{ $film[8]['image'] }}" alt="blog2" />
                        </div>
                        <div class="paper-blog2-under">
                            <p class="paper-blog2-time">
                                <span
                        ...
                        <div class="paper-blog2-content">
                            <a href="{{ route('detail', ['id' => $film[8]['id']]) }}"
                                style="color: #020202; text-decoration:none">
                        ...
                        <div class="paper-blog2-button">
                            <a
                                href="{{ route('detail', ['id' => $film[8]['id']]) }}"><button>
                                    Daha çox
                                    <img src="{{ asset('back/assets/img/more.png') }}" alt="more" />
                                </button>
                            </a>
                ...
                <div class="col-md-3 mt-3 paper-blog2-bottom-left-col">
                    <div class="paper-blog2-bottom-left">
                        ...
                        <div class="paper-blog2-content">
                            ...
                            <a href="{{ route('detail', ['id' => $film[9]['id']]) }}"
                                style="color: #020202; text-decoration:none">
                        ...
                        <div class="paper-blog2-button">
                            <a
                                href="{{ route('detail', ['id' => $film[9]['id']]) }}"><button>
                                    Daha çox
                                    <img src="{{ asset('back/assets/img/more.png') }}" alt="more">
                                </button>
                            </a>
                    ...
                    <div class="paper-1">
                        <img class="paper-1-img" src="{{ $film[10]['image'] }}"
                            alt="paper-1-img">
                        <div class="blog-det">
                            <div class="blog-date">
                        ...
                        <div class="blog-det-3">
                            <a
                                href="{{ route('detail', ['id' => $film[10]['id']]) }}"><button
                                    class="read-more">
                                    Daha çox
                                    <img src="{{ asset('back/assets/img/more.png') }}" alt="">
                                </button>
